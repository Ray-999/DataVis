...
define([
    ...
    function (AbsentResourceList,
        ...
        /**
         * Determines if the tile subdivision of the provided TileMatrixSet is compatible with visualize.
         * @param tileMatrixSet
         * @returns {boolean} true if this tile subdivision will work with visualize
        ...
        WmtsLayer.formLayerConfiguration = function (wmtsLayerCapabilities, style, matrixSet, imageFormat) {
            ...
            // Validate that the specified TileMatrixSet exists and is compatible with visualize
            if (matrixSet) {
